...
| **前端** | shadcn/ui RadioGroup、Select 組件 |
...
| 類型 | 路徑 |
| --- | --- |
| 靜態版 | `wireflow/ad-authorization-global-settings-v1.2-20260205.html` |
| 互動版 | `wireflow/ad-authorization-global-settings-v1.2-20260205-interactive.html` |
...
| v1.2 | 2026-02-05 | 將手動覆蓋授權從 Badge+Popover 改為 Dropdown，符合 MASTER.md 組件規範 | Claude |
